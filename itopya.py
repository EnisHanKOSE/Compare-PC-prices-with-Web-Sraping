...
def final_itopya():
    ...
    newgpulist=[]
    for line in Lines:
        newgpulist.append(line.strip())
        newgpulist.append("RTX 3090 Ti")
        newgpulist.append("RTX 3090")
        newgpulist.append("RTX 3070 Ti")
        newgpulist.append("RTX 3080 Ti")
        newgpulist.sort(reverse=True)
